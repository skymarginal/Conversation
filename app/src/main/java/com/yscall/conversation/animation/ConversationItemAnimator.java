package com.yscall.conversation.animation;
...
//        if (holder instanceof SearchRecyclerAdapter.ProblemTextHolder) {
//            searchEnum = SearchEnum.PROBLEM_TEXT;
//        } else if (holder instanceof SearchRecyclerAdapter.AnswerLoadingHolder) {
//            searchEnum = SearchEnum.ANSWER_LOADING;
//        } else {
//            searchEnum = SearchEnum.ANSWER_TEXT;
//        }
//
//        final View view = holder.itemView;
//        final ViewPropertyAnimator animation = view.animate();
...
//    }
    ...
    public interface AnimationEndListener {
        void onAnimationEnd(ContentEnum contentEnum);
    }
